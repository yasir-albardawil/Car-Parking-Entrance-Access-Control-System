...
public class ManageUsersAddDialogController {
	@FXML
	...
	public void setUsers(Login login) throws ClassNotFoundException {
		...
		passwordTextField.setText(login.getPassword());
	...
	private void handleOk() throws Exception {
		if (isInputValid()) {
			...
			MySQLJDBCDriverConnection.insertUser(usernameTextField.getText(),
					MD5encrption.EncryptText(passwordTextField.getText()), roleComboBox.getValue());
			SQLiteJDBCDriverConnection.insertUser(usernameTextField.getText(),
					MD5encrption.EncryptText(passwordTextField.getText()), roleComboBox.getValue());
